...
class ParserTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        m.values = {
            'cpu_usage': '0.01104',
	    'memory_rss': '28389376',
            'memory_usage': '106688512',
            'memory_working_set': '63107072'
        }
        ...
        m.values = {
            'cpu_usage': '0.00004',
	    'memory_rss': '180224',
            'memory_usage': '73990144',
            'memory_working_set': '30420992'
        }
        self.expectedCollection.append(m)
    ...
    def test_pod_metrics(self):
        ...
        self.maxDiff = None
        self.assertDictEqual(self.expectedCollection.metrics[0].values, collection.metrics[0].values)
    ...
    def test_pod_containersmetrics(self):
        ...
        self.maxDiff = None
        self.assertDictEqual(self.expectedCollection.metrics[1].values, collection.metrics[1].values)
